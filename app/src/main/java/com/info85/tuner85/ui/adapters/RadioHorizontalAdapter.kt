...
import com.info85.tuner85.databinding.ItemRadioHorizontalBinding

class RadioHorizontalAdapter(
    private val onItemClick: (RadioStation, Int) -> Unit
) : ListAdapter<RadioStation, RadioHorizontalAdapter.ViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemRadioHorizontalBinding.inflate(
    ...
    inner class ViewHolder(private val binding: ItemRadioHorizontalBinding) :
